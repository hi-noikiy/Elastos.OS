...
private:
     ...
     */
    static const Double EXP_COEFFICIENT_RECORD;

    /**
     * See {@link #EXP_COEFFICIENT_RECORD}.
     */
    static const Double EXP_COEFFICIENT_MONITOR;
     ...
     */
    static const Double POOR_LINK_LOSS_THRESHOLD;

    /**
     * See {@link #POOR_LINK_LOSS_THRESHOLD}.
     */
    static const Double GOOD_LINK_LOSS_THRESHOLD;
     ...
     */
    static const Double POOR_LINK_MIN_VOLUME;
