...
private:
    ...
    // Default values.
    static const Int32 DEFAULT_EDGE_TYPE;
    static const Int32 DEFAULT_MINIMUM_VELOCITY_DIPS;
    static const Int32 DEFAULT_MAXIMUM_VELOCITY_DIPS;
    static const Float DEFAULT_MAXIMUM_EDGE;
    static const Float DEFAULT_RELATIVE_EDGE;
    static const Float DEFAULT_RELATIVE_VELOCITY;
    static const Int32 DEFAULT_ACTIVATION_DELAY; //= ViewConfiguration.getTapTimeout();
    static const Int32 DEFAULT_RAMP_UP_DURATION;
    static const Int32 DEFAULT_RAMP_DOWN_DURATION;
};
