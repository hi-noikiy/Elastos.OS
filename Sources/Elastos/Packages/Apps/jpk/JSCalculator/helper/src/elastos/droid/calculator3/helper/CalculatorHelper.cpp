...
#include "elastos/droid/calculator3/helper/CalculatorHelper.h"
...
const String CalculatorHelper::NAME("JSCalculatorHelper");
const String CalculatorHelper::KEY_CURRENT_STATE = NAME + "_currentState";
const String CalculatorHelper::KEY_CURRENT_EXPRESSION = NAME + "_currentExpression";

//----------------------------------------------------------------
//           Calculator::MyTextWatcher
//----------------------------------------------------------------
CalculatorHelper::MyTextWatcher::MyTextWatcher(
    /* [in] */ CalculatorHelper* host)
    : mHost(host)
{}

CAR_INTERFACE_IMPL(CalculatorHelper::MyTextWatcher, Object, ITextWatcher)

ECode CalculatorHelper::MyTextWatcher::BeforeTextChanged(
...
ECode CalculatorHelper::MyTextWatcher::OnTextChanged(
    /* [in] */ ICharSequence* charSequence,
    /* [in] */ Int32 start,
    /* [in] */ Int32 count,
    /* [in] */ Int32 after)
...
ECode CalculatorHelper::MyTextWatcher::AfterTextChanged(
...
//----------------------------------------------------------------
CalculatorHelper::MyOnKeyListener::MyOnKeyListener(
    /* [in] */ CalculatorHelper* host)
    : mHost(host)
{}

CAR_INTERFACE_IMPL(CalculatorHelper::MyOnKeyListener, Object, IViewOnKeyListener)

ECode CalculatorHelper::MyOnKeyListener::OnKey(
    /* [in] */ IView* view,
    /* [in] */ Int32 keyCode,
...
CalculatorHelper::MyEditableFactory::MyEditableFactory(
    /* [in] */ CalculatorHelper* host)
    : mHost(host)
{}

CAR_INTERFACE_IMPL(CalculatorHelper::MyEditableFactory, Object, IEditableFactory)

ECode CalculatorHelper::MyEditableFactory::NewEditable(
...
//----------------------------------------------------------------
CalculatorHelper::RevealAnimatorListenerAdapter::RevealAnimatorListenerAdapter(
    /* [in] */ CalculatorHelper* host,
...
ECode CalculatorHelper::RevealAnimatorListenerAdapter::OnAnimationEnd(
...
//----------------------------------------------------------------
CalculatorHelper::OnClearAnimatorListenerAdapter::OnClearAnimatorListenerAdapter(
    /* [in] */ CalculatorHelper* host)
    : mHost(host)
{}

ECode CalculatorHelper::OnClearAnimatorListenerAdapter::OnAnimationEnd(
    /* [in] */ IAnimator* animation)
{
...
//----------------------------------------------------------------
CalculatorHelper::OnErrorAnimatorListenerAdapter::OnErrorAnimatorListenerAdapter(
    /* [in] */ CalculatorHelper* host,
...
ECode CalculatorHelper::OnErrorAnimatorListenerAdapter::OnAnimationEnd(
    /* [in] */ IAnimator* animation)
{
...
//----------------------------------------------------------------
CalculatorHelper::MyAnimatorUpdateListener::MyAnimatorUpdateListener(
    /* [in] */ CalculatorHelper* host)
    : mHost(host)
{}

CAR_INTERFACE_IMPL(CalculatorHelper::MyAnimatorUpdateListener, Object, IAnimatorUpdateListener)

ECode CalculatorHelper::MyAnimatorUpdateListener::OnAnimationUpdate(
...
//----------------------------------------------------------------
CalculatorHelper::OnResultAnimatorListenerAdapter::OnResultAnimatorListenerAdapter(
    /* [in] */ CalculatorHelper* host,
...
ECode CalculatorHelper::OnResultAnimatorListenerAdapter::OnAnimationStart(
    /* [in] */ IAnimator* animation)
{
    return ITextView::Probe(mHost->mResultEditText)->SetText(StringUtils::ParseCharSequence(mResult));
}

ECode CalculatorHelper::OnResultAnimatorListenerAdapter::OnAnimationEnd(
    /* [in] */ IAnimator* animation)
{
...
CAR_INTERFACE_IMPL_2(CalculatorHelper::InnerListener, Object, IOnTextSizeChangeListener, IViewOnLongClickListener)

CalculatorHelper::InnerListener::InnerListener(
    /* [in] */ CalculatorHelper* host)
    : mHost(host)
{
}

ECode CalculatorHelper::InnerListener::OnLongClick(
    /* [in] */ IView* iview,
    /* [out] */ Boolean* result)
{
...
ECode CalculatorHelper::InnerListener::OnEvaluate(
...
ECode CalculatorHelper::InnerListener::OnTextSizeChanged(
...
//           Calculator
//----------------------------------------------------------------
//CAR_INTERFACE_IMPL_3(CalculatorHelper, Activity, IEvaluateCallback, ICalculator, ICalculatorListener)
CAR_INTERFACE_IMPL_3(CalculatorHelper, Object, IEvaluateCallback, ICalculator, ICalculatorListener)
...
ECode CalculatorHelper::constructor()
{
    ...
    ECode rc;
    //////rc = Activity::constructor();
    return rc;
}

ECode CalculatorHelper::constructor(PInterface host)
{
    ECode rc;
    rc = constructor();
...
ECode CalculatorHelper::OnCreate(
    /* [in] */ IContext* ctx,
    /* [in] */ IBundle* savedInstanceState)
{
    ALOGD("CalculatorHelper::OnCreate====begin====0000====");

    ECode ec = NOERROR;

    //////Activity::OnCreate(savedInstanceState);
    mHost->SetContentView(R::layout::activity_calculator);

    mDisplayView = mHost->FindViewById(R::id::display);
    mFormulaEditText = ICalculatorEditText::Probe(mHost->FindViewById(R::id::formula));
    mResultEditText = ICalculatorEditText::Probe(mHost->FindViewById(R::id::result));
    AutoPtr<IView> tmpView = mHost->FindViewById(R::id::pad_pager);
    mPadViewPager = IViewPager::Probe(mHost->FindViewById(R::id::pad_pager));
    mDeleteButton = mHost->FindViewById(R::id::del);
    mClearButton = mHost->FindViewById(R::id::clr);

    tmpView = mHost->FindViewById(R::id::pad_numeric);
    ...
    if (mEqualButton == NULL || (mEqualButton->GetVisibility(&visibility), visibility != IView::VISIBLE)) {
        tmpView = NULL;
        tmpView = mHost->FindViewById(R::id::pad_operator);
        tmpView->FindViewById(R::id::eq, (IView**)&mEqualButton);
    }
    ...
    ALOGD("CalculatorHelper::OnCreate====end========");

    return ec;
}

ECode CalculatorHelper::OnSaveInstanceState(
    /* [in] */ IContext* ctx,
    /*[in] */ /*@NonNull */IBundle* outState)
{
    ALOGD("CalculatorHelper::OnSaveInstanceState====begin====");
...
void CalculatorHelper::SetState(
    /*[in] */ CalculatorState state)
{
    ALOGD("CalculatorHelper::SetState====begin====");
...
ECode CalculatorHelper::OnBackPressed(
    /* [in] */ IContext* ctx)
{
    ALOGD("CalculatorHelper::OnBackPressed====begin====");
    Int32 currentItem;
...
ECode CalculatorHelper::OnUserInteraction(
    /* [in] */ IContext* ctx)
{
    ALOGD("CalculatorHelper::OnUserInteraction====begin====");
...
ECode CalculatorHelper::OnButtonClick(
    /* [in] */ IView* iview)
{
    ALOGD("CalculatorHelper::OnButtonClick====begin====");
...
ECode CalculatorHelper::OnLongClick(
    /* [in] */ IView* iview,
    /* [out] */ Boolean* result)
{
    ALOGD("CalculatorHelper::OnLongClick====begin====");
    VALIDATE_NOT_NULL(result);
...
ECode CalculatorHelper::OnEvaluate(
    /* [in] */ const String& expr,
    /* [in] */ const String& result,
    /* [in] */ Int32 errorResourceId)
{
    ALOGD("CalculatorHelper::OnEvaluated====begin====");
...
ECode CalculatorHelper::OnTextSizeChanged(
    /* [in] */ ITextView* textView,
    /* [in] */ Float oldSize)
{
    ALOGD("CalculatorHelper::OnTextSizeChanged====begin====");
    if (mCurrentState != INPUT) {
...
void CalculatorHelper::OnEquals()
{
    ALOGD("CalculatorHelper::OnEquals====begin====");
    if (mCurrentState == INPUT) {
        SetState(EVALUATE);
        AutoPtr<ICharSequence> cs;
        ITextView::Probe(mFormulaEditText)->GetText((ICharSequence**)&cs);
...
void CalculatorHelper::OnDelete()
{
    ALOGD("CalculatorHelper::OnDelete====begin====");
...
void CalculatorHelper::Reveal(
    /* [in] */ IView* sourceView,
    /* [in] */ Int32 colorRes,
    /* [in] */ IAnimatorListener* listener)
{
    ALOGD("CalculatorHelper::Reveal====begin====");
    AutoPtr<IWindow> window;
    mHost->GetWindow((IWindow**)&window);
    AutoPtr<IView> dView;
    ...
    CView::New(mHost, (IView**)&revealView);
...
void CalculatorHelper::OnClear()
{
    ALOGD("CalculatorHelper::OnClear====begin====");
    AutoPtr<ICharSequence> cs;
    ITextView::Probe(mFormulaEditText)->GetText((ICharSequence**)&cs);
...
void CalculatorHelper::OnError(
    /* [in] */ Int32 errorResourceId)
{
    ALOGD("CalculatorHelper::OnError====begin====");
...
void CalculatorHelper::OnResult(
    /* [in] */ const String& result)
{
    ALOGD("CalculatorHelper::OnResult====begin====");
    // Calculate the values needed to perform the scale and translation animations,
