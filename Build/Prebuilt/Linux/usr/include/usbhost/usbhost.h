...
int usb_device_claim_interface(struct usb_device *device, unsigned int interfaceToken);

/* Releases the specified interface of a USB device */
int usb_device_release_interface(struct usb_device *device, unsigned int interfaceToken);
...
int usb_device_connect_kernel_driver(struct usb_device *device,
        unsigned int interfaceToken, int connect);
...
int usb_device_set_interface(struct usb_device *device, unsigned int interfaceToken,
